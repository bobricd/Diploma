...
class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument('number', type=int, help='how many moderated announcements generate')
    ...
    def handle(self, *args, **options):
        ...
        for _ in range(options['number']):
            ...
            announcement = Announcement.objects.create(
                ...
                is_moderate=True,
                approved=True,
                moderate_message=fake.random_element(Announcement.ModerateIncorrectMessage.values)
            )
        ...
        print(f'Moderated announcements created successfully')
